...
require (
	...
	github.com/redhat-appstudio/service-provider-integration-scm-file-retriever v0.5.2
)
...
require (
	...
	github.com/redhat-appstudio/service-provider-integration-operator v0.5.2 // indirect
